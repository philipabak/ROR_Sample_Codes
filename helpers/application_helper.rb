...
module ApplicationHelper
  ...
  def script(*args)
    if SiteSetting.enable_cdn_js_debugging && GlobalSetting.cdn_url
      ...
      tags.gsub!("/assets/", "/cdn_asset/#{Application.current_hostname.tr(".","_")}/")
  ...
  def render_sitelinks_search_tag
    json = {
      ...
      potentialAction: {
        '@type' => 'SearchAction',
        target: "#{Application.base_url}/search?q={search_term_string}",
